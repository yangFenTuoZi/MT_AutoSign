...
public class Main {
    public static final String UA = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36";
    ...
    public static void main(String[] args) {
        ...
        headers = new String[][]{{"Cookie", "cQWy_2132_saltkey=" + saltKey}, {"Content-type", "application/x-www-form-urlencoded; charset=UTF-8"}, {"User-Agent", UA}};
        ...
        if (cQWy_2132_auth.isEmpty()) {
            System.out.println("MT论坛---登录失败");
            return;
        }

        //获取formhash
        headers = new String[][]{{"accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9"}, {"User-Agent", UA}, {"Cookie", "cQWy_2132_saltkey=" + saltKey + ";cQWy_2132_auth=" + cQWy_2132_auth}};
        ...
        headers = new String[][]{{"Cookie", params[2][1]}, {"Referer", "https://bbs.binmt.cc/forum.php"}, {"User-Agent", UA}};
        ...
        if (request.text.contains("今日已签")) {
            ...
            if (matcher.find()) {
                System.out.println("错误信息" + matcher.group(0));
            }
            System.out.print("完整信息: " + request.text);
        }
    }
}
